        ...
        <AnimatePresence>
            ...
            />
                ...
                >
                    ...
                    <div className='px-5 flex-1 overflow-auto space-y-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden'>

                        <div className='rounded-xl border border-white/10 p-4'>
                            <h3 className='text-white font-semibold'>Starter Plan</h3>
                            <p className='text-indigo-400 text-2xl font-bold mt-2'>₹249</p>
                            <p className='text-slate-400 text-sm mt-1'>400 Credits</p>
                        ...
                        <div className='rounded-xl border border-white/10 p-4'>
                            <h3 className='text-white font-semibold'>Advanced Plan</h3>
                            <p className='text-indigo-400 text-2xl font-bold mt-2'>₹999</p>
                            <p className='text-slate-400 text-sm mt-1'>2500 Credits</p>
                            <button className='mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white' onClick={() => handleUpgrade("advanced")}>Upgrade</button>
                        </div>
                    </div>
