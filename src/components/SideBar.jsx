...
//   Handle Pins
  ...
  if (collapsed) {
    return (
      <>
        <button
          className="lg:hidden fixed top-3.5 left-4 z-50 flex items-center justify-center w-9 h-9 rounded-xl bg-[#111522]/95 border border-white/[0.1] text-slate-300 shadow-lg shadow-black/20 backdrop-blur-xl hover:border-indigo-300/50 transition-colors duration-150 cursor-pointer"
          onClick={() => {
            setCollapsed(false);
            setMobileOpen(true);
          }}
