      ...
      setConvTitle:(state,action)=>{
       ...
       setConversationPinned:(state,action)=>{
             ...
             state.conversations=state.conversations
               .map((conv)=>conv._id==conversationId?{...conv,pinned}:conv)
               .sort((a,b)=>Number(b.pinned)-Number(a.pinned))
             if(state.selectedConversation?._id==conversationId){
               state.selectedConversation={...state.selectedConversation,pinned}
             }
           },
...
export const {setConversations,addConversation,setSelectedConversation,setConvTitle,setConversationPinned,removeConversation}=conversationSlice.actions 
